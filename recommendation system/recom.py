...
loaded_model = joblib.load(r'C:\Users\devan\OneDrive\Desktop\Results\models\ldamodel10.pkl')
index = 1 #this is the index of the circuit
dist, ind = loaded_tree.query([loaded_model[index]], k= 50)

print(dist)
print(ind)

wr = open(r'C:\Users\devan\OneDrive\Desktop\Results\kdtest10new.txt','w', encoding="utf8")
