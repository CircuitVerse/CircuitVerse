...
export function newCircuit(name, id) {
    ...
    $('#tabsBar').append(`<div style='display: flex' class='circuits toolbarButton current' id='${scope.id}'><span>${name}</span><span class ='tabsCloseButton' id='${scope.id}'  ><i class="fa tabsCirDeleteIcon fa-trash" aria-hidden="true"></i></span></div>`);
