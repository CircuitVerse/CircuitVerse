    ...
    (function () {
        function X(e) {
            ...
            function w(j) {
                if (
                    !(
                        j.type == "readystatechange" &&
                        x.readyState != "complete"
                    ) &&
                    ((j.type == "load" ? n : x)[z](i + j.type, w, !1),
                    !m && (m = !0))
                )
                    e.call(n, j.type || j);
            }
        ...
        var $ = (function () {
            ...
            (function () {
                function j(a) {
                    ...
                    for (
                        var j = 0, F = !1, l = !1, I = 0, c = a.length;
                        I < c;
                        ++I
                    ) {
                        var p = a[I];
