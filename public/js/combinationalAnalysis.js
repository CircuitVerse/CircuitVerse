/* jshint esversion: 6 */
/* eslint-disable no-debugger, no-console, no-alert, no-bitwise */
        ...
        buttons: [
            {
                ...
                click() {
                    ...
                    for (const output in data) {
                        const temp = new BooleanMinimize(inputListNames.length, data[output][1].map(Number), data[output].x.map(Number));
...
function createCombinationalAnalysisPrompt(scope = globalScope) {
        ...
        buttons: [
            {
                ...
                click() {
                    ...
                    var inputList = $('#inputNameList')
                        .val()
                        .split(',');
                    var outputList = $('#outputNameList')
                        .val()
                        .split(',');
