 ...
 */
/**
 * represents the number of total objects in simulation
 * area. All circuit elements and nodes are counted as objects
 * Note: wires are not.
 * @type {number}
 */
var totalObjects = 0;
 ...
 * @param {Scope=} scope - the scope whose dimensions we want
 */
function findDimensions(scope = globalScope) {
    ...
    // iterates through all the all objects in the scope and checks what is the dimension of the whole scope
    for (let i = 0; i < updateOrder.length; i++) {
