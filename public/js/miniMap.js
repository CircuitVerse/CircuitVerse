        ...
        for (var i = 0; i < lst.length; i++) {
            if (lst[i] === "wires") {
                ...
                for (var j = 0; j < globalScope[lst[i]].length; j++) {
                    ...
                    var yy =
                        globalScope[lst[i]][j].y - simulationArea.minHeight;
                    this.ctx.beginPath();
