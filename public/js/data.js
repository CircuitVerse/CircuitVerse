...
function newCircuit(name, id) {
    ...
    $('#tabsBar').append("<div class='circuits toolbarButton current' id='" + scope.id + "'>" + name + "<span class ='tabsCloseButton' id = '"+scope.id +"' onclick='deleteCurrentCircuit()'  >x</span></div>");
