    ...
    e.fn.checkBo = function (c) {
        return (
            ...
            this.each(function () {
                ...
                var l = e(this);
                var a = l.find('.cb-checkbox');
                var d = l.find('.cb-radio');
                var o = l.find('.cb-switcher');
                var s = a.find('input:checkbox');
                var f = d.find('input:radio');
                s.wrap('<span class="cb-inner"><i></i></span>'),
                f.wrap('<span class="cb-inner"><i></i></span>');
                var k = new t('input:checkbox');
                var r = new t('input:radio');
                if (
                    ...
                    var u = e(this);
                    u.find(e(c.checkAllButton)).on('click', () => {
                        u
