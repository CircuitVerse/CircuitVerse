...
Rails.application.routes.draw do
  ...
  scope "/users" do
    ...
    patch "/:id/notifications/enable", to: "users/noticed_notifications#enable", as: "enable_notifications"
    patch "/:id/notifications/disable", to: "users/noticed_notifications#disable", as: "disable_notifications"
    patch "/:id/notifications/enable_all", to: "users/noticed_notifications#enable_all", as: "enable_all_notifications"
    patch "/:id/notifications/disable_all", to: "users/noticed_notifications#disable_all", as: "disable_all_notifications"
