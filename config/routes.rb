...
Rails.application.routes.draw do
  ...
  scope "/users" do
    ...
    post "/:id/notifications/enable", to: "users/noticed_notifications#enable", as: "enable_notifications"
    post "/:id/notifications/enable_star", to: "users/noticed_notifications#enable_star", as: "enable_star_notifications"
    post "/:id/notifications/enable_fork", to: "users/noticed_notifications#enable_fork", as: "enable_fork_notifications"
    post "/:id/notifications/disable", to: "users/noticed_notifications#disable", as: "disable_notifications"
    post "/:id/notifications/disable_star", to: "users/noticed_notifications#disable_star", as: "disable_star_notifications"
    post "/:id/notifications/disable_fork", to: "users/noticed_notifications#disable_fork", as: "disable_fork_notifications"
    get "/:id/notifications/edit", to: "users/noticed_notifications#edit", as: "edit_notifications"
