...
class LtiSupport
  def initialize(oauth_consumer_key)
    @oauth_consumer_key = oauth_consumer_key
    @assignment = Assignment.find_by(lti_consumer_key: @oauth_consumer_key)
  end

  def lti_score_submit(lis_result_sourced_id, score, lis_outcome_service_url)
    ...
    consumer = OAuth::Consumer.new(@oauth_consumer_key, @assignment.lti_shared_secret)
