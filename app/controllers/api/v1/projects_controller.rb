...
class Api::V1::ProjectsController < Api::V1::BaseController
  ...
  before_action :authenticate_user!, only: %i[check_edit_access create update update_circuit destroy toggle_star create_fork]
  ...
  before_action :set_project, only: %i[check_edit_access show circuit_data update destroy toggle_star create_fork]
