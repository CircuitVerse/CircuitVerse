...
class AssignmentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @assignment.save
        format.html { redirect_to @group, notice: t("assignment.created") }
  ...
  def update
    ...
    respond_to do |format|
      if @assignment.update(params)
        format.html { redirect_to @group, notice: t("assignment.updated") }
  ...
  def destroy
    @assignment.destroy
    respond_to do |format|
      format.html { redirect_to @group, notice: t("assignment.deleted") }
