...
class MentorshipsController < ApplicationController
  ...
  def create
    ...
    mentorship_emails = Utils.parse_mails_except_current_user(mentorship_params[:emails],
                                                                 current_user)
  ...
  def destroy
    ...
    @mentorship.destroy
    respond_to do |format|
      format.html { redirect_to group_path(@group), notice: "Mentorship relation was successfully destroyed." }
