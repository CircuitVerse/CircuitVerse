...
describe AssignmentPolicy do
  ...
  context "user is a group member" do
    ...
    context "assignment is open" do
      let(:assignment) { create(:assignment, group: @group, status: "open") }
      ...
      context "project is already submitted" do
        before do
          create(:project, author: @member, assignment: assignment)
        end
    ...
    context "assignment is closed" do
      let(:assignment) { create(:assignment, group: @group, status: "closed") }
