...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/workspace/CircuitVerse/vendor/bundle/ruby/3.0.0/gems/nokogiri-1.13.8/ports/x86_64-linux/libxslt/1.1.35/lib/libxslt-plugins"
#endif
