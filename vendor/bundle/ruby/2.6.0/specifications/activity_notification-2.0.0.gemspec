# -*- encoding: utf-8 -*-
# stub: activity_notification 2.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<railties>.freeze, [">= 4.2.0", "< 6.1"])
      ...
      s.add_development_dependency(%q<dynamoid>.freeze, [">= 3.0.0", "< 3.2.0"])
      ...
      s.add_dependency(%q<railties>.freeze, [">= 4.2.0", "< 6.1"])
      ...
      s.add_dependency(%q<dynamoid>.freeze, [">= 3.0.0", "< 3.2.0"])
