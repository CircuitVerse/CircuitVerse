...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/workspace/CircuitVerse/vendor/bundle/ruby/2.6.0/gems/nokogiri-1.12.5/ports/x86_64-pc-linux-gnu/libxslt/1.1.34/lib/libxslt-plugins"
#endif
