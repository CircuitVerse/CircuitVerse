...
description: 'description' }, { name:'Public',
author_id: users.first.id,
project_access_type: 'Public',
description: 'description' }, { name:'Limited access',
author_id: users.first.id,
...
project_access_type: 'Public',
description: 'description' },{ name:'SAP',
author_id: users.first.id,
data: File.read('db/examples/SAP.json'),
project_access_type: 'Public',
description: 'SAP-1 short for simple as possible computer is a 8 Bit computer. It can perform simple operations like Addition and Subtraction.' },{ name:'ALU-74LS181',
author_id: users.first.id,
data: File.read('db/examples/ALU-74LS181.json'),
project_access_type: 'Public',
description: 'description' }])
...
project_id: projects.second.id },{ tag_id: tag.id,
