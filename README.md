...
To help new contributors get started, we have created a video guide titled **"Getting Started with CircuitVerse"**. This video covers:
...
*(Click the link above to watch the video on YouTube for a complete walkthrough.)*
