<p align = "center">  
  <img src="/app/assets/images/cvlogo.svg" alt="The CircuitVerse logo" width="736" alignment="center"/></br></br>
</p>
...
-----
[CircuitVerse](https://circuitverse.org) is a free, open-source platform that allows users to construct digital logic circuits online. We also offer the [Interactive Book](https://learn.circuitverse.org) which teaches users the fundamentals of modern, digital circuits. Please also see our [documentation](https://docs.circuitverse.org) or [GitHub Wiki](https://github.com/CircuitVerse/CircuitVerse/wiki/).
