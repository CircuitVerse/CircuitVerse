...
* First Create Google, Facebook, Github app by following the steps mentioned [Here](https://github.com/CircuitVerse/CircuitVerse/wiki/Create-Apps).
* Configure your env in .env, copy .env.example ( Note: update the ``ID`` and ``Secret`` in its respective place. )
