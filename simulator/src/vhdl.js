...
export var vhdl = {
    ...
    exportVHDLScope: function (id, visited, dependencyList, elementTypesUsed) {
        ...
        if((hasComponent(scope.Multiplexer)) || (hasComponent(scope.Demultiplexer)) || (hasComponent(scope.Decoder)) || (hasComponent(scope.Dlatch)) || (hasComponent(scope.DflipFlop)) || (hasComponent(scope.TflipFlop))){
            output += ""
        } else{
            output += "  BEGIN\n";
        }
        ...
        if((!hasComponent(ScopeComponents.Demultiplexer)) && (!hasComponent(ScopeComponents.Multiplexer)) && (!hasComponent(ScopeComponents.Decoder)) && (!hasComponent(ScopeComponents.Dlatch)) && (!hasComponent(scope.DflipFlop)) && (!hasComponent(scope.TflipFlop))){
    ...
    processGraph: function (scope, elementTypesUsed) {
        ...
        for (var elem of VHDLSet) {
            if((componentVHDL==0) && ((elem.objectType == 'Demultiplexer') || (elem.objectType == 'Multiplexer') || (elem.objectType == 'Decoder') || (elem.objectType == 'Dlatch')) || (elem.objectType == 'DflipFlop') || (elem.objectType == 'TflipFlop')){
        ...
        for (var elem of VHDLSet) {
            if((portVHDL==0) && ((elem.objectType == 'Demultiplexer') || (elem.objectType == 'Multiplexer') || (elem.objectType == 'Decoder') || (elem.objectType == 'Dlatch') || (elem.objectType == 'DflipFlop') || (elem.objectType == 'TflipFlop'))){
        ...
        for (var elem of VHDLSet) {
            if((elem.objectType != 'Multiplexer') && (elem.objectType != 'Demultiplexer') && (elem.objectType != 'Decoder') && (elem.objectType != 'Dlatch') && (elem.objectType != 'DflipFlop') && (elem.objectType != 'TflipFlop')){
                res += elem.generateVHDL() + "\n";
            }
        }
